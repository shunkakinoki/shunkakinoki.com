export default class SocialLinks {
  ...
  static readonly instagram = `https://instagram.com/${SocialLinks.shunkakinoki}`;
  static readonly keybase = `https://keybase.io/${SocialLinks.shunkakinoki}`;
  static readonly line = "https://line.me/ti/p/jxc0rpPhBv";
  static readonly linkedin = `https://linkedin.com/in/${SocialLinks.shunkakinoki}`;
