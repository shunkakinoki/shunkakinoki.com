...
export default function Header(): JSX.Element {
  return (
    <nav className={s.glass}>
      <header
        role="banner"
        className="sticky z-30 flex items-center justify-between w-full max-w-3xl p-8 px-6 py-3 mx-auto my-0 mb-3 text-gray-400 align-baseline box-border leading-5 transition ease-in sm:mb-6 md:my-8 bg-opacity-60"
      >
