...
export function Life() {
  ...
  return (
    <section>
      ...
      <div class="divide-y divide-border-strong overflow-hidden rounded-lg border border-border-strong bg-background-strong shadow sm:grid sm:grid-cols-3 sm:gap-px sm:divide-x sm:divide-y-0">
        {actions.map((action, actionIdx) => (
          ...
          >
            ...
            <div class="mt-8">
              <h3 class="font-semibold text-base text-text/80 leading-6">
                {/* @ts-expect-error */}
            ...
            <span
              class="pointer-events-none absolute top-6 right-6 text-text"
              aria-hidden="true"
            >
